...
export const templates: KokoTemplate[] = [
  ...
  },
  {
    ...
    descEs: 'TanStack Router SPA + Java Spring Boot 3 + PostgreSQL + Docker. El estándar backend de alta concurrencia empresarial.',
    descEn: 'TanStack Router SPA + Java Spring Boot 3 + PostgreSQL + Docker. The enterprise standard for high-concurrency backends.',
    icon: SvglJavaLogo,
    config: {
      selectedFront: 'tanstack-router',
      selectedNativeFront: 'none',
      selectedBack: 'spring',
      selectedDb: 'postgres',
      selectedAuth: 'none',
  ...
  },
  {
    ...
    descEs: 'TanStack Router SPA + Node.js Express + MongoDB + Mongoose. El stack legendario para aplicaciones web modernas.',
    descEn: 'TanStack Router SPA + Node.js Express + MongoDB + Mongoose. The legendary stack for modern web applications.',
  ...
  },
  {
    ...
    descEs: 'TanStack Router SPA + Node.js Express + PostgreSQL + Prisma ORM. Una base relacional sólida y tipada para escalar.',
    descEn: 'TanStack Router SPA + Node.js Express + PostgreSQL + Prisma ORM. A solid, typesafe relational foundation to scale.',
  ...
  {
    id: 'python-fastapi',
    nameEs: 'FastAPI + TanStack Router SPA',
    nameEn: 'FastAPI + TanStack Router SPA',
    descEs: 'TanStack Router SPA + Python FastAPI + PostgreSQL + Docker. Stack asíncrono ideal para plataformas de IA y datos.',
    descEn: 'TanStack Router SPA + Python FastAPI + PostgreSQL + Docker. Asynchronous stack ideal for AI & data platforms.',
    icon: SvglPythonLogo,
    config: {
      selectedFront: 'tanstack-router',
      selectedNativeFront: 'none',
  ...
  },
  {
    ...
    descEs: 'Expo React Native + Node Express API + PostgreSQL + Better-Auth. Desarrollo móvil multiplataforma líder.',
    descEn: 'Expo React Native + Node Express API + PostgreSQL + Better-Auth. Industry-leading cross-platform mobile stack.',
    icon: SvglReactLogo,
    config: {
      selectedFront: 'none',
      selectedNativeFront: 'native-bare',
      selectedBack: 'express',
      selectedDb: 'postgres',
      selectedAuth: 'better-auth',
      selectedPackageManager: 'pnpm',
